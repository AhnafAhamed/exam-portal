 					...
 					<div class="panel-body">
 						...
 						<div class="form-group">
 							...
 							<select class="form-control" name="question_type" onChange="hidenop(this.value);">
 								...
 								<option value="3" style="display:none;"><?php echo $this->lang->line('match_the_column'); ?></option>
 								<option value="4" style="display:none;"><?php echo $this->lang->line('short_answer'); ?></option>
 								<option value="5" style="display:none;"><?php echo $this->lang->line('long_answer'); ?></option>
 						...
 						<div class="form-group">
 							<input style="display: none;" type="checkbox" name="with_paragraph" value="1"> <?php /* echo $this->lang->line('with_paragraph'); */ ?></div>

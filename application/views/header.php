...
<head>
  ...
  <style>
    ...
    .sidebar {
      ...
      background-color: #0c179a !important;
...
<body id="page-top">
  ...
  ?>
      ...
      <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primarys sidebar sidebar-dark accordion" id="accordionSidebar">

          <!-- Sidebar - Brand -->
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">

            <!-- <div class="sidebar-brand-text mx-3"> ScienceClassLK </div> -->
            <div class="sidebar-brand-text mx-3"><?php if ($hres[0]['setting_value'] == "") { ?>ScienceClassLK<?php } else {
          ...
          ?>
            ...
            <li class="nav-item">
              <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseStudy" aria-expanded="true" aria-controls="collapseStudy">
                ...
                <span><?php echo  "Resources";/*$this->lang->line('study_material');*/ ?></span>
              </a>
              <div id="collapseStudy" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">

                  <a class="collapse-item" href="<?php echo site_url('study_material'); ?>"><?php echo "Resources List";/*$this->lang->line('study_material');*/ ?></a>
                </div>
              </div>
            </li>
          ...
          ?>
            <a style="display: none;" href="<?php echo site_url('user/switch_group'); ?>" class="btn btn-danger" style="border-radius:0px;"><?php echo $this->lang->line('change_group'); ?></a>
          <?php
          }
          ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
              ...
              <button id="sidebarToggle" class="btn btn-link d-md-none rounded-circle mr-3" onclick="reveal()">
	 ...
	 where appointment_request.to_id='$uid' and appointment_request.appointment_status='Pending' ");
	  ...
	  where (savsoft_notification.uid='$uid' OR savsoft_notification.uid='0') AND (savsoft_notification.viewed='0')  ");
                ...
                <li class="nav-item dropdown no-arrow mx-1">
                  ...
                  <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                    ...
                    ?><a class="dropdown-item d-flex align-items-center" href="#">
                        <div class="small text-gray-500"><span class="font-weight-bold"><?php echo "No notification for you!"; ?></span></div>
                      </a><?php
                        }
                          ?>
                ...
                <li class="nav-item dropdown no-arrow">
                  <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="display:block !important;">
                      <b style="text-transform: uppercase;"><?php echo $logged_in['first_name'] . ' ' . $logged_in['last_name']; ?> </b> </span>
                    <!-- <img class="img-profile rounded-circle" src="../images/sci-logo.png"> -->
                  </a>
                  ...
                  <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    ...
                    <a style="display: none;" class="dropdown-item" href="<?php echo site_url('user/edit_user/' . $logged_in['uid']); ?>">
                    ...
                    if (in_array('List', explode(',', $logged_in['appointment'])) && !in_array('List_all', explode(',', $logged_in['appointment']))) { ?>
                      <b><a class="dropdown-item" href="<?php echo site_url('appointment/myappointment/'); ?>"><i class="fas fa-mobile fa-sm fa-fw mr-2 text-gray-400"></i><?php echo $this->lang->line('myappointment'); ?></a></b>
                    <?php } ?>
        ...
        <script>
          ...
          // }
          function reveal() {
            document.getElementById("accordionSidebar").classList.toggle("reveal");
          }
        </script>
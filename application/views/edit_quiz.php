  					...
  					<div class="panel-body">
  						...
  						<div id="advance_options" class="collapse">
  							...
  							<div class="form-group">
  								...
  								<input type="radio" name="view_answer" value="0" <?php if ($quiz['view_answer'] == 0) {
																						echo 'checked';
  							...
  							<div class="form-group" style="display: none;">
  								...
  								<input type="radio" name="with_login" value="1" <?php if ($quiz['with_login'] == 1) {
																						echo 'checked';
																					} ?>> <?php echo $this->lang->line('no'); ?>
  							</div>
  							...
  							<div class="form-group" style="display: none;">
  								...
  								<input type="radio" name="show_chart_rank" value="1" <?php if ($quiz['show_chart_rank'] == 1) {
																							echo 'checked';
																						} ?>> <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;
  								<input type="radio" name="show_chart_rank" value="0" <?php if ($quiz['show_chart_rank'] == 0) {
																							echo 'checked';
																						} ?>> <?php echo $this->lang->line('no'); ?>
  							</div>
  							...
  							<?php
								...
								?>
  								<div class="form-group" style="display: none;">
  									...
  									<input type="radio" name="camera_req" value="1" <?php if ($quiz['camera_req'] == 1) {
																							echo 'checked';
																						} ?>> <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;
  									<input type="radio" name="camera_req" value="0" <?php if ($quiz['camera_req'] == 0) {
																							echo 'checked';
																						} ?>> <?php echo $this->lang->line('no'); ?>
  								</div>
  							...
  							<div class="form-group">
  								...
  								<?php
									...
									?>
  									...
  									<input type="checkbox" name="gids[]" value="<?php echo $val['gid']; ?>" <?php if (in_array($val['gid'], explode(',', $quiz['gids']))) {
																													echo 'checked';
  							...
  							<div class="form-group">
  								...
  								<label><?php echo "Assign to specific students"; ?></label> <br>


  								<select class="js-example-basic-multiple form-control" name="uids[]" multiple="multiple" style="width:300px;">
  									<?php foreach ($user_list as $k => $uval) { ?>
  										<option value="<?php echo $uval['uid']; ?>" <?php if (in_array($uval['uid'], explode(',', $quiz['uids']))) {
																							echo 'selected';
																						} ?>><?php echo $uval['first_name'] . ' ' . $uval['last_name'] . ' (' . $uval['email'] . ')'; ?></option>
  									<?php } ?>
  								</select>
  							...
  							<div class="form-group" style="display: none;">
  								...
  								<select name="quiz_template">
  									<?php
										...
										?>
  										<option value="<?php echo $val; ?>" <?php if ($quiz['quiz_template'] == $val) {
																					echo 'selected';
																				} ?>><?php echo $val; ?></option>
  									<?php
										}
  							...
  							<div class="form-group" style="display: none;">
  								...
  								<input type="radio" name="gen_certificate" value="1" <?php if ($quiz['gen_certificate'] == 1) {
																							echo 'checked';
																						} ?>> <?php echo $this->lang->line('yes'); ?><br>
  								<input type="radio" name="gen_certificate" value="0" <?php if ($quiz['gen_certificate'] == 0) {
																							echo 'checked';
																						} ?>> <?php echo $this->lang->line('no'); ?>
  							</div>
  									...
  									<?php
										...
										?>
  										<tr>
  											...
  											<td><input type="text" style="width:60px;" name="i_correct[]" value="<?php if (isset($quiz['correct_score'][$key])) {
																														echo explode(',', $quiz['correct_score'])[$key];
																													} else {
																														echo '1';
																													} ?>"> </td>
  											<td><input type="text" style="width:60px;" name="i_incorrect[]" value="<?php if (isset($quiz['incorrect_score'][$key])) {
  									...
  									<select name="cid[]">
  										...
  										<?php
											...
											?>
  											...
  											<option value="<?php echo $val['cid']; ?>" <?php if ($val['cid'] == $vall['cid']) {
																								echo 'selected';

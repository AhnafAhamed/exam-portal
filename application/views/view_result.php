 ...
 <div class="container">
 	...
 	<div class="row noprint">
 		<?php
			...
			?>
 		<div class="col-lg-12" style="color:black;min-height:400px;">
 			<div class="col-lg-12">
 				<center>
 					<h3><span style="color:#0c179a; font-weight:bold;">
 							<?php echo $this->lang->line('hello'); ?> <?php echo $result['first_name']; ?>
 							<?php echo $result['last_name']; ?></span> <?php /*echo str_replace('{attempt_no}', ordinal($attempt), $this->lang->line('title_result'));*/ ?> </h3>
 				</center>
 			</div>
 			<div class="col-lg-12">
 				<center>
 					<h2><span><?php echo $result['quiz_name']; ?> </span></h2>
 				</center>
 			</div>
 			<div class="row" style="margin-top:20px;">
 				<div class="col-lg-2" style="text-align:center;">
 					<p style="font-size: 24px;font-weight:bold;"><?php echo $this->lang->line('score_obtained'); ?></p>
 					<p style="color:#0c179a; font-size:20px;"><?php echo $result['score_obtained']; ?> / <?php echo $result['noq']; ?></p>
 				</div>
 				<div class="col-lg-2" style="text-align:center;">
 					<p style="font-size: 24px;font-weight:bold;"><?php echo $this->lang->line('time_spent'); ?></p>
 					<p style="color:#0c179a; font-size:20px;"><?php echo secintomin($result['total_time']); ?> Minutes.</p>

 				</div>
 				<div class="col-lg-2" style="text-align:center;">
 					<p style="font-size: 24px;font-weight:bold;"><?php echo $this->lang->line('attempt_time'); ?></p>
 					<p style="color:#0c179a; font-size:20px;"><?php echo date('Y-m-d H:i:s', $result['start_time']); ?></p>

 				</div>
 				<div class="col-lg-2" style="text-align:center;">
 					<p style="font-size: 24px;font-weight:bold;"><?php echo $this->lang->line('percentage_obtained'); ?></p>
 					<p style="color:#0c179a; font-size:20px;"><?php echo $result['percentage_obtained']; ?>%</p>

 				</div>
 				<div class="col-lg-2" style="text-align:center; display:none;">
 					<p style="font-size: 24px;font-weight:bold;"><?php echo $this->lang->line('percentile_obtained'); ?></p>
 					<p style="color:#0c179a; font-size:20px;"><?php echo substr(((($percentile[1] + 1) / $percentile[0]) * 100), 0, 5);   ?>%</p>

 				</div>

 				<div class="col-lg-2" style="text-align:center;">
 					<p style="font-size: 24px;font-weight:bold;"><?php echo $this->lang->line('status'); ?></p>
 					<p style="color:#0c179a; font-size:20px;"><?php echo $result['result_status']; ?></p>
 			...
 			<div class="col-lg-12" style="display:none; margin-top:20px;">
 				<center>
 					<?php
 			...
 			<div class="col-lg-12" style="display:none; margin-top:50px;color:#dddddd;font-size:14px;">
 				...
 				<div class="panel-body">
 					...
 					<table class="table table-bordered">
 						<?php
							...
							?>
 							<tr>
 								<td colspan='2'> <?php if ($result['photo'] != '') { ?> <img src="<?php echo base_url('photo/' . $result['photo']); ?>" id="photograph"><?php } ?></td>
 							</tr>
 						...
 						<div class='box'>
 							...
 							<div class='animatedimage'>
 								...
 								<?php
									...
									?>
 									<img src='<?php echo base_url($file); ?>' style="width:600px;height:300px;" <?php if ($j == 0) {
																														echo "class='poster'";
																													} ?>>
 									<!-- <b><?php echo $fname[2] . '-' . $fname[3] . '-' . $fname[4] . '-' . $fname[5] . '-' . $fname[6] . '-' . $fname[7]; ?></b> -->
 				...
 				<div class="col-md-12">
 							...
 							<tbody>
 								<?php
									...
									foreach (explode(',', $result['categories']) as $vk => $category) {
										$cate_sco = 0;
										if (isset($cia_cat[0][$vk])) {
											$no_C = $cia_cat[0][$vk];
											$correct += $cia_cat[0][$vk];
										} else {
											$no_C = 0;
										}
										if (isset($cia_cat[1][$vk])) {
											$no_iC = $cia_cat[1][$vk];
											$incorrect += $cia_cat[1][$vk];
										} else {
											$no_iC = 0;
										}
									...
									?>
 									<tr>
 										...
 										<td><?php if (isset($cia_cat[2][$vk])) {
													echo $cia_cat[2][$vk];
													$notattempted += $cia_cat[2][$vk];
												} else {
													echo '0';
												} ?></td>
 					...
 					<center><?php
								...
								if ($query->num_rows() == 1) {
									...
									} else if ($ad['banner'] != '') { ?><a style="display: none;" href="<?php echo $ad['banner_link']; ?>" target="new_add"><img src="<?php echo base_url('upload/' . $ad['banner']); ?>" class="img-responsive"></a> <?php
 					...
 					<div class="col-md-12">
 						<?php
							...
							?>
 							...
 							<script type="text/javascript">
 								...
 								function drawChart() {
 									...
 									var options = {
 										...
 										hAxis: {
 											title: '<?php echo $this->lang->line('quiz'); ?>(<?php echo $this->lang->line('user'); ?>)',
 											titleTextStyle: {
 												color: 'red'
 											}
 										}
 							...
 							<div id="chart_div2" style="display:none; width:800px; height: 500px;"></div>
 							<!-- google chart ends -->
 							...
 							<div class="panel-body">
 								...
 								<?php
									...
									?>
 									...
 									<div class="rqn" id="qn<?php echo $qk; ?>" style=" <?php if ($qk == 0) {
																							echo 'display:block;';
																						} else {
																							echo 'display:none;';
																						} ?>">
 												...
 												<?php
													...
													?>
 													...
 													<?php
														...
														?>
 															<?php if (in_array($option['oid'], $save_ans)) {

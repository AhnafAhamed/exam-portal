 				...
 				<div class="login-panel panel panel-default">
 					<div class="panel-body">
 						...
 						<table class="table table-bordered">
 							...
 							<tr>
 								<td colspan='2'><?php echo $this->lang->line('description'); ?><br><?php echo $quiz['description']; ?></td>
 							</tr>
 							<tr>
 								<td><?php echo $this->lang->line('start_date'); ?></td>
 								<td><?php echo date('Y-m-d H:i:s', $quiz['start_date']); ?></td>
 							</tr>
 							<tr>
 								<td><?php echo $this->lang->line('end_date'); ?></td>
 								<td><?php echo date('Y-m-d H:i:s', $quiz['end_date']); ?></td>
 							</tr>
 							<tr>
 							...
 							<?php $ex = explode(',', $quiz['correct_score']);
								if (count($ex) <= 1) { ?>
 								<tr>
 								...
 								<tr>
 									<td><?php echo $this->lang->line('incorrect_score'); ?></td>
 									<td><?php echo $quiz['incorrect_score']; ?></td>
 								</tr>
 							<?php } ?>
 							<tr style="display: none;">
 								<td><?php echo $this->lang->line('select_language'); ?></td>
